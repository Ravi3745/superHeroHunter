...
//function to show hero's depends on search also filter heros depends on key press
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-12 text-center">
                    <span class="display-1 d-block" style="color:maroon; font-weight:800;">404</span>
                    <div class="mb-4 lead" style="color:white;">The hero you are looking for was not found.</div>
                </div>
            </div>
        </div>
    </div>
